...
const Explore = () => {
  ...
  return (
    <section id="explorer" ref={sectionRef} className="section-container">
      <SectionTitle
      ...
      <div className="mt-16 grid grid-cols-1 lg:grid-cols-3 gap-12">
        <div className="lg:col-span-2 reveal-on-scroll">
          <h3 className="text-2xl font-bold text-sahara-brown mb-6">Destinations Sahraouies</h3>
          ...
          <div className="mt-12">
            <h3 className="text-2xl font-bold text-sahara-brown mb-6">Carte Interactive des Régions Sahariennes</h3>
            <div className="bg-sahara-sand/20 rounded-lg overflow-hidden aspect-video relative shadow-md">
              <div className="absolute inset-0 flex items-center justify-center">
                <p className="text-center p-6">
                  [Carte interactive du Sahara marocain avec les principales destinations touristiques]
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="reveal-on-scroll">
          <h3 className="text-2xl font-bold text-sahara-brown mb-6">Conseils de Voyage</h3>
          ...
          <div className="mt-8 p-6 bg-gradient-to-br from-sahara-orange/20 to-sahara-terracotta/20 rounded-lg shadow-md">
            ...
            <ul className="space-y-2 text-sm">
              <li>Le Sahara peut être extrêmement chaud le jour et froid la nuit</li>
              <li>Les tempêtes de sable sont plus fréquentes entre février et avril</li>
              <li>Le réseau téléphonique est souvent limité dans le désert profond</li>
              <li>Prévoyez des espèces, les cartes bancaires ne sont pas acceptées partout</li>
            </ul>
          </div>
        </div>
      </div>
