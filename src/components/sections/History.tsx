...
const History = () => {
  ...
  return (
    <section id="histoire" ref={sectionRef} className="section-container" dir={language === 'ar' ? 'rtl' : 'ltr'}>
      ...
      {/* Nouvelle section sur le dialecte hassani et sa relation avec l'arabe */}
      <div className="mt-16 p-8 bg-gradient-to-r from-sahara-terracotta/10 to-sahara-brown/10 rounded-lg border border-sahara-sand/30 reveal-on-scroll">
        <h3 className="text-2xl font-bold text-sahara-brown mb-4">Langue Arabe & Dialecte Hassani</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="space-y-4">
            <h4 className="font-bold text-sahara-terracotta text-xl mb-2">Origines et Influence</h4>
          ...
          <div className="space-y-4">
            <h4 className="font-bold text-sahara-terracotta text-xl mb-2">Transmission et Préservation</h4>
            <p className="text-base">
